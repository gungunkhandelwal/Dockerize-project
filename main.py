...
async def items_list():
    ...
    try:
        ...
        query = """
            SELECT * FROM rail_sathi_railsathicomplain 
        ...
        for complaint in complaints:
            serialized_complaint = {}
            for key, value in complaint.items():
                if isinstance(value, (datetime, date)):
                    serialized_complaint[key] = value.isoformat()
                else:
                    serialized_complaint[key] = value
        ...
        return {
            ...
            "data": serialized_complaints,
            "count": len(serialized_complaints)
        }
